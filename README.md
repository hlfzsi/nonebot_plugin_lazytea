...
![1753779214444](images/README/1753779214444.png)

#### bot页面

![1753779501509](images/README/1753779501509.png)![1753779504916](images/README/1753779504916.png)![1753779508243](images/README/1753779508243.png)

#### 消息页面

![1753779612117](images/README/1753779612117.png)![1753779615397](images/README/1753779615397.png)

#### 插件页面

![1753779698765](images/README/1753779698765.png)![1753779702984](images/README/1753779702984.png)
...
* 配置钩子：您可以选择性地提供一个与您插件包**导入名**同名的函数。当插件的配置被更新时，LazyTea会自动调用这个函数，并将**包含了所有最新配置值的配置实例作为唯一的参数**进行传递。这允许了插件配置热重载。
...
* [ ]  **更多合作**: 我们积极寻求与其他插件开发者的合作，努力打造NoneBot的UI生态。
* [ ]  **远程控制**: 提供单独的LazyTea GUI客户端，允许远程操作您的Bot实例。
* [ ]  **多平台支持**: 受限于Qt，我们暂时只能支持桌面，但移动端的支持仍然是我们的目标。
* [ ]  **更完善的用户支持**：我们计划在QQ上建立LazyTea交流群，以提供更好的用户支持。但目前用户规模有限，尚无法组织社群。当项目在GitHub上获得50个star时，我们将立即创建交流群，与社区成员更紧密地互动。
